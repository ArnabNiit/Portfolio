  ...
  return (
    <div className='flex justify-between p-12 m-6'>
      ...
      <form>
        ...
        <div>
          <button type='submit' className='bg-amber-300 rounded p-3 m-10 animate-ping  hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300'>
            Sent
          </button>
        </div>
