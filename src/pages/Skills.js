  ...
  return (
    ...
    <div class="left">
      <div class="skill">
        ...
        <li><h3>Tailwind Css</h3>
          <span class="bar"><span class="tailwindcss"></span></span>
        </li>
        <li><h3>Express js</h3>
          <span class="bar"><span class="expressjs"></span></span>
        </li>
        <li><h3>Mongo DB</h3>
      ...
      <div class="right">
        ...
        <li><h3>Teamwork</h3>
          <span class="bar"><span class="teamwork"></span></span>
        </li>
        <li><h3>Communication</h3>
          <span class="bar"><span class="communication"></span></span>
        </li>
        <li><h3>Critical Thinking</h3>
          <span class="bar"><span class="criticalthinking"></span></span>
        </li>
        <li><h3>Time Management</h3>
          <span class="bar"><span class="timemanagement"></span></span>
        </li>
        <li><h3>Creativity</h3>
          <span class="bar"><span class="creativity"></span></span>
        </li>
        <li><h3>Emotional Intelligency</h3>
          <span class="bar"><span class="emotional"></span></span>
        </li>
